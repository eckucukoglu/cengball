...
public class MatchPanel extends JPanel {
	...
	private void arrangeLayout() { 
		...
		scorePanel.setBounds(0, 0, width, 80);
		buttonPanel.setBounds(0, height-60, width, 60);
		commentaryPanel.setBounds(0, height-100, width, 40);
		visualizer.setBounds(0, 80, width, height - (scorePanel.getHeight() + buttonPanel.getHeight() + commentaryPanel.getHeight()) );
		ssButton.setBounds(buttonPanel.getWidth()/2 - 80, buttonPanel.getHeight()/2 - 25, 160, 50);
		backButton.setBounds(10, buttonPanel.getHeight()/2 - 25, 100, 50);
		skipButton.setBounds(buttonPanel.getWidth()-210, buttonPanel.getHeight()/2 - 25, 200, 50);
		team1Name.setBounds(0, scorePanel.getHeight()/2 - 40, 240, 80 );
		team2Name.setBounds(buttonPanel.getWidth() - 240, scorePanel.getHeight()/2 - 40, 240, 80 );
		time.setBounds(scorePanel.getWidth()/2 - 100, scorePanel.getHeight()/2 - 30, 200, 60 );
		team1Score.setBounds(team1Name.getWidth() + 10, scorePanel.getHeight()/2 - 40, 100, 80 );
		team2Score.setBounds(team2Name.getX() - 110, scorePanel.getHeight()/2 - 40, 100, 80 );
		nextButton.setBounds(ssButton.getX() + ssButton.getWidth() + 10, buttonPanel.getHeight()/2 - 25, 100, 50 );
		prevButton.setBounds(ssButton.getX() - 110, buttonPanel.getHeight()/2 - 25, 100, 50 );
